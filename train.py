...
def get_args():
    ...
    parser.add_argument("--data_path", type=str, default="data/volleyball", help="the root folder of the data")
...
def train(args):
    ...
    train_set = VolleyballDataset(root=args.data_path, year="2012", image_set="train", download=False, transform=train_transform)
    val_set = VolleyballDataset(root=args.data_path, year="2012", image_set="val", download=False, transform=val_transform)
    train_params = {
